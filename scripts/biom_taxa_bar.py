...
def main():
    ...
    taxLevel = input("Enter a # for taxonomic level (Phylum:2 -  Genus:6): ")
    mapCat =  input("Enter a mapping category to organize samples (IN QUOTES): ")
    ...
    for values, id, metadata in table_rel_col_sort.iter(axis='sample'):
        print count, id, metadata[mapCat]
        count += 1
